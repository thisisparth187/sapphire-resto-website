        ...
        <StyledWrapper>
            <div className="card">
                ...
                <div className="card__content">
                    <div style={{ backgroundImage: `url(${roomBg})` }} className="card__image" />
...
const StyledWrapper = styled.div`
  .card {
    ...
    --card-accent: #EEEEEE;
    --card-text: #EEEEEE;
    --card-shadow: 0 10px 15px -3px rgba(194, 157, 105, 0.7);
  ...
  .card:hover .card__button {
    transform: scale(1);
    box-shadow: 0 0 0 4px rgba(194, 157, 105, 1);
  }
